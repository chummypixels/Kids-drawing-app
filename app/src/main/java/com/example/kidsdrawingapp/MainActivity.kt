            ...
            if(requestCode == GALLERY){
                try {
                    if(data!!.data != null){
                        ...
                        Toast.makeText(this, "Error parsing image or is corrupted", Toast.LENGTH_LONG).show()
                    }
                }catch (e: Exception){
                    e.printStackTrace()
                }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == STORAGE_PERMISSION_CODE){
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this, "Permission granted, now you can read storage", Toast.LENGTH_LONG).show()
            }else{
                Toast.makeText(this, "Oops, you have denied permission", Toast.LENGTH_LONG).show()
            }
        }
    }
